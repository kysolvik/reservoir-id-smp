...
# Args:
out_base_path=./out_allbrazil_30m/${satellite}
model_gs_path=gs://res-id/cnn/models/best_smp/manet_resnet_model25.ckpt

mean_std_path=gs://res-id/cnn/training/prepped_gaip/mean_std_sentinel_v11.npy
bands_minmax_path=gs://res-id/cnn/training/prepped_gaip/all_imgs_bands_min_max_sentinel_v11.npy

# Careful! Cannot include trailing '/' in data_path
data_path_s1_10m=gs://res-id/ee_exports/sentinel1_10m_allbrazil_v11
data_path_s2_10m=gs://res-id/ee_exports/sentinel2_10m_allbrazil_v11
data_path_s2_20m=gs://res-id/ee_exports/sentinel2_20m_allbrazil_v11
...
mkdir -p vrts
gdalbuildvrt vrts/${satellite}_${y}_s1_10m.vrt -r average -te -74.0539679 -33.7869853 -34.7077585 5.3175773 -tap -tr 0.000269494585236 0.000269494585236 -input_file_list filelist_s1_10m.txt 
gdalbuildvrt vrts/${satellite}_${y}_s2_10m.vrt -r average -te -74.0539679 -33.7869853 -34.7077585 5.3175773 -tap -tr 0.000269494585236 0.000269494585236 -input_file_list filelist_s2_10m.txt 
gdalbuildvrt vrts/${satellite}_${y}_s2_20m.vrt -r cubic -te -74.0539679 -33.7869853 -34.7077585 5.3175773 -tap -tr 0.000269494585236 0.000269494585236 -input_file_list filelist_s2_20m.txt 
# Small area test
