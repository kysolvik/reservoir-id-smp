...
class ResModelMAnet(pl.LightningModule):
...
class ResModelUnet(pl.LightningModule):

    def __init__(self, arch, encoder_name, in_channels, out_classes, crs, **kwargs):
        super().__init__()
        self.model = smp.Unet(encoder_name=encoder_name, in_channels=in_channels, classes=out_classes,
                               aux_params=dict(
                                   classes=1,
                                   dropout=None)
                               )
