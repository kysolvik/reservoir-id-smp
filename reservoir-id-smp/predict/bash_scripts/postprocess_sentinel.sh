...
do
    ...
    fp_aea="./fullout/aea/${filename_base}_aea_esri_tiled.tif"
    ...
    gsutil cp $fp_wgs84 gs://res-id/cnn/predict/sentinel_v6/full_outputs/
    gsutil cp $fp_aea gs://res-id/cnn/predict/sentinel_v6/full_outputs_aea/
